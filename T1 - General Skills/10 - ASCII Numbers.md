...
### Solución
Dado que solo nos arrojan la cadena de texto codificada en hexadecimal, utilizaremos una herramienta que nos permita convertir de hexadecimal a código ASCII, optando por Cyberchef, donde se ingresa lo siguiente:
...
Obteniendo así la bandera que resuelve el reto:
